...
public class SchedulerUI {
    ...
    private static void setupSchedulerData() {
        ...
        // Courses
        Course Math101 = new Course("Math 101", true, 3, Arrays.asList(math101_01, math101_02), Arrays.asList(Semester.Term.Spring));
        ...
        Course CS201 = new Course("CS 201", true, 3, 0, Arrays.asList(cs201_01),null, Arrays.asList(Semester.Term.Fall, Semester.Term.Spring, Semester.Term.Winter, Semester.Term.Summer), Arrays.asList("2023"));
        ...
        Course Physics201 = new Course("Physics 201", true, 3, 1, Arrays.asList(physics201_lecture), physics201_lab, Arrays.asList(Semester.Term.Fall, Semester.Term.Spring, Semester.Term.Winter, Semester.Term.Summer), null);
